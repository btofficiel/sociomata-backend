    ...
    server.route({
        ...
        handler: async (request, h) => {
            try {
                ...
                const webhookSecret = 'whsec_iDQtLYbgfyLkWL1dfBLnJMbcrYDmcTvm';
                if (webhookSecret) {
                ...
                switch (eventType) {
                    case 'checkout.session.completed':
                        ...
                        break;
                    case 'invoice.paid':
                        const intent = await stripe.paymentIntents.retrieve(data.object.payment_intent);
                    ...
                    line_items: [
                        {
                            ...
                            quantity: 1,
                            tax_rates: ['txr_1JlCfQKcyxmBD8j5axKGxYie']
                        }
                    ],
